...
//            case SUB -> result + " = " + inputs[0] + " - " + inputs[1];
//            case SHL -> result + " = " + inputs[0] + " << " + inputs[1];
//            case AND -> result + " = " + inputs[0] + " & " + inputs[1];
//            case XOR -> result + " = " + inputs[0] + " ^ " + inputs[1];
//            case OR -> result + " = " + inputs[0] + " | " + inputs[1];
//            case MOV -> result + " = " + inputs[0];
//            case LOAD -> result + " = MEM[" + inputs[0] + "]";
//            case BRNZ -> "if " + inputs[0] + " != 0 goto " + inputs[1] + " else goto " + inputs[2];
//            case JMP -> null;
//            case PHI -> null;
//        };
//    }
